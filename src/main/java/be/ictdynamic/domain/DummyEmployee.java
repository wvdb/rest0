...
public class DummyEmployee {
    ...
    public DummyEmployee() {
        LOGGER.info(">>>DummyEmployee : empty constructor");
    }

    public DummyEmployee(String commune1, String address1, String country1, String commune2, String address2, String country2, Double latitude, Double longitude, Map<String, Integer> durationMap, Map<String, Integer> distanceMap) {
        this.commune1 = "steven";
        this.address1 = "gijs";
        this.country1 = "lokeren";
